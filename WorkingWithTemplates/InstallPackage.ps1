...
$pathtonuspec = Join-Path $srcDir BlogDoFT.Template.NetCoreTool.nuspec
...
$pathtonupkg = join-path $scriptDir nupkg/BlogDoFT.Template.NetCoreTool.nuspec.1.0.0.nupkg
